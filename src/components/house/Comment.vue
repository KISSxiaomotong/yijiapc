            ...
            <div class="content">
                ...
                <div class="info">
                    <div v-for="(item,index) in lists" :key="index">
                        ...
                        <div>
                            <h3>{{item.obj.userName}}<span>{{item.obj.cdate}}</span></h3>
                            <p>{{item.comment}}</p>
                        </div>
                    </div>
                ...
                <div class="publish_comment">
                    ...
                    <div class="publish_content">
                        <p>评价：</p>
                        <textarea placeholder="关于这个楼盘，关于看房买房，爽的不爽的，直接说出来，你的评论，有态度！"></textarea>
                    </div>
                    <button>提交评论</button>
                </div>
            </div>
...
<style scoped>
    ...
    .publish_grade>p{
        ...
        line-height: 30px;
        padding-right: 35px;
        background-image: url("../../assets/images/house/must.png");
        background-repeat: no-repeat;
    ...
    .publish_grade>ul>li{
        ...
        width: 69px;
        padding-left: 46px;
        background-image: url("../../assets/images/house/smile.png");
        background-repeat: no-repeat;
    ...
    .publish_content>textarea::-webkit-input-placeholder{
        color: #acaaaa;
    }
    .publish_comment>button{
        width: 200px;
        height: 35px;
        display: block;
        margin: 0 auto;
